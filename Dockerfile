...
COPY scripts/postinstall-bundled-plugins.mjs scripts/postinstall-ssrf-caddy.mjs scripts/caddy-ssrf-version.txt scripts/preinstall-package-manager-warning.mjs scripts/npm-runner.mjs scripts/windows-cmd-helpers.mjs ./scripts/
